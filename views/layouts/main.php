        ...
        <div class="menu-content">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    <li><a data-toggle="dropdown" class="dropdown-toggle" href="<?= Url::toRoute('site/index');?>">Блог</a>
                ...
                <div class="i_con">
                    ...
                    <li><a href="<?= Url::toRoute(['site/index'])?>">Домашняя</a></li>
                    <?php elseif(!Yii::$app->user->isGuest && Yii::$app->user->identity->name): ?>
                    <li><a href="<?= Url::toRoute(['blog/default/index'])?>">Создать статью</a></li>
                    <?php endif;?>
                    </ul>
                </div>
                <div class="i_con">
